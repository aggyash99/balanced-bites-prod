        ...
        <div className="col-lg-4 col-md-12 mb-lg-0 mb-4">
          <div className="card testimonial-card">
            ...
            <div className="card-body testimonial-card">
              ...
              <hr />
              <p className="dark-grey-text mt-4 testimonial">
                <i className="fas fa-quote-left pr-2"></i>
                <EllipsisText
                  text={`I have lost approx 3kg with great inch loss in a short period of 2 months. It was very much difficult for me to loose weight with my medical conditions but still u have done wonders. I am enjoying my food, now I have the knowledge of healthy eating. The diet plans were just awesome and easy to follow. I really liked the experience with Dt. Muskan, really appreciate her help. Highly Recommend.`}
                  length="300"
                />
              </p>
            </div>
          ...
          <div className="card testimonial-card">
            ...
            <div className="card-body testimonial-card">
              ...
              <p className="dark-grey-text mt-4 testimonial">
                <i className="fas fa-quote-left pr-2"></i>
                <EllipsisText
                  text={`Best experience till now. Dietitian Muskan is highly professional and provided me diet plan according to my daily eating habits, changes can be noticed from first week itself. After 3 weeks i was able to reduce more than 7 kgs without any changes my daily routine
Thank you so much to help me getting back in shape after lockdown ❤❤.`}
                  length="300"
                />
              </p>
            </div>
