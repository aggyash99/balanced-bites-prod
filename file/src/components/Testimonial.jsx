        ...
        <Box component="fieldset"  border="transparent">
         ...
         <Rating name="read-only" value={3} readOnly></Rating>
            ...
            <div className="card-body">
              ...
              <hr /> 
              <p className="dark-grey-text mt-4 testimonial"><i className="fas fa-quote-left pr-2"></i>I have lost approx 3kg with great inch loss in a short period of 2 months. It was very much difficult for me to loose weight with my medical conditions but still u have done wonders. I am enjoying my food, now I have the knowledge of healthy eating. The diet plans were just awesome and easy to follow. I really liked the experience with Dt. Muskan, really appreciate her help. Highly Recommend.</p>
            </div>
          </div>
