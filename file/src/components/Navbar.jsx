  ...
  window.onscroll = function () {
    if ($(window).width() > 450) {
      if (document.getElementById('movingpicbg'))
        document.getElementById('movingpicbg').style.backdropFilter =
          'blur(' + 0.05 * window.scrollY + 'px)';
      var dynWidth;
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top top-0">
        <a
          className="btn btn-outline  navHamBurger"
          id="primaryHamButton"
          onClick={() => {
            console.log(navOpen);
            if (navOpen === 0) {
        ...
        >
          <div style={{ display: 'block' }}>
            <span className="hamMod ham1" id="hamOpt"></span>
            <span className="hamMod ham2" id="hamOpt2"></span>
            <span className="hamMod ham3" id="hamOpt3"></span>
          </div>{' '}
        </a>
        <div className="container-fluid" style={{ justifyContent: 'center' }}>
          <nav className="d-flex">
            <div style={{ display: 'inherit' }}>
              <NavLink className="navbar-brand " to="/">
                <img
                  className="img-fluid img-thumbnail Navbar-image navImg2"
                  src={logo}
                  alt="Balanced Bites"
                  id="brandImg"
                  style={{}}
            ...
            <ul className="navbar-nav ms-auto ">
              <li className="nav-item navDesktop">
                <NavLink
                  ...
                  to="/"
                >
                  <span className="nav-name navbarhover" id="nav1">
                    Home
                  </span>
                </NavLink>
              ...
              <li className="nav-item  navDesktop">
                <NavLink
                  ...
                  onClick={navCollapse}
                >
                  <span className="nav-name navbarhover " id="nav4">
                    About
                  </span>
                </NavLink>
                <div className="navbaranim start-home" id="animNavbar"></div>{' '}
              ...
              <li className="nav-item programHover navDesktop">
                <NavLink
                  ...
                  to="/Service"
                >
                  <span className="nav-name navbarhover" id="nav2">
                    Program
                  </span>
                </NavLink>
                <div className="navbaranim start-home" id="animNavbar"></div>
                <span className="transitionElementProgram"></span>
                <div className="submenuprogram" id="smp">
                  <ul className="submenuprogram">
                    {data.map((value, key) => {
                      return (
                        <Link
                          to={{ pathname: '/Program', state: { key: key } }}
                          key={key}
                        >
                          <li>{value.title}</li>
                        </Link>
              ...
              <li className="nav-item  navDesktop">
                <NavLink
                  ...
                  onClick={navCollapse}
                >
                  <span className="nav-name navbarhover" id="nav3">
                    Contact
                  </span>
                </NavLink>
                <div className="navbaranim start-home" id="animNavbar"></div>
          ...
          <a
            className="btn btn-outline navClose fullscreenMove2"
            id="navClose"
            onClick={() => {
              navCollapse();
              navOpen = 0;
          ...
          <div className="fullscreenWrapper fullscreenMove" id="navFullScreen">
            <div
              className="navWrapper submenuprogram2"
              id="navitemwrappermobile"
            >
              <ul className="navItemWrapper  " id="">
                <li className="navItems  " onClick={navCollapse}>
                  <NavLink
                    ...
                    to="/"
                  >
                    <span className="nav-name  navItemMobile" id="nav1">
                      Home
                    </span>
                  </NavLink>
                  <div className="navbaranim start-home" id="animNavbar"></div>{' '}
                ...
                <li className="navItems programHover">
                  <div className="dropdownLine">
                    ...
                    >
                      <span
                        className="nav-name  navItemMobile"
                        id="nav2"
                        onClick={navCollapse}
                      >
                        Program
                    ...
                    <a
                      id="dropdown"
                      style={{ trasfrom: 'rotateZ(90deg)' }}
                      className=" btn  subMenuDropDownIcon"
                      type="button"
                      onClick={() => {
                        if (dropOpen) {
                          dropdownClose();
                  ...
                  <span className="transitionElementProgram"></span>
                  <div className="submenuMobile " id="subMenuMobile">
                    <ul className="submenuUL">
                      <li className="backiconnavli">
                        <a
                          id="dropdown"
                          className=" btn  subMenuDropDownIcon2"
                          type="button"
                          onClick={() => {
                            if (dropOpen) {
                              dropdownClose();
                ...
                <li className="navItems  " onClick={navCollapse}>
                  <NavLink
                    ...
                    to="/Contact"
                  >
                    <span className="nav-name  navItemMobile" id="nav3">
                      Contact
                    </span>
                  </NavLink>
                  <div className="navbaranim start-home" id="animNavbar"></div>
                ...
                <li className="navItems  " onClick={navCollapse}>
                  <NavLink
                    ...
                    to="/About"
                  >
                    <span className="nav-name  navItemMobile" id="nav4">
                      About
                    </span>
                  </NavLink>
                  <div className="navbaranim start-home" id="animNavbar"></div>{' '}
