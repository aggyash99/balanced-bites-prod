        ...
        <div className=" Review">
          ...
          <div className="Heading-border">
            <div className="write-review">
              <img
                src="https://res.cloudinary.com/balance-bites/image/upload/v1624256854/Home_carousel/google_zkt4nr.png"
                alt="G"
              ></img>
              <span>Reviews</span>
            </div>
            ...
            <div className="">
              <a
                href="https://g.page/r/CWK5lavoG8jkEAg/review"
                className="btn-for-program"
              >
                Review
              </a>
            </div>
